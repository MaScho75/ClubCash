...
<body>
	<div id="display">
		...
		<div id="menubar">
			...
			<button onclick="loadKassenliste();">Tagesabrechnung</button>
		</div>
	</div>
...
async function loadKassenliste() {
    try {
        let response = await fetch("get_kassenliste.php");
		...
		thead.innerHTML = "<tr><th>Datum</th><th>Zeit</th><th>Terminal</th><th>Produkt EAN</th><th>Preis</th><th>MwSt</th><th>Kunde</th></tr>";
