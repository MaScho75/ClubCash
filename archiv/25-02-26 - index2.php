...
$csvDatei = "kunden.csv"; // Name der CSV-Datei
$kunden = [];
...
$csvDatei = "produkte.csv"; // Name der CSV-Datei
$produkte = [];
...
<script>
		...
		let tastenkontrolle = function(event) {
            ...
            if (event.key === "Enter") {
				...
				console.log("Test1:", eingabe);
				
		    	kundenprüfung(eingabe);
				
				console.log("Test2:", eingabe);
